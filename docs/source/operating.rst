[mysecondproject-b4b4] Operating Details
====================================

Generated On: 2024-10-10 16:51:56 UTC
...
.. important::
   ...
   **not be valid if your [mysecondproject-b4b4] container is NOT running**.

.. tip::
   You must have your [mysecondproject-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39291  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasun.athugoda@gmail.com'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasun.athugoda@gmail.com/mysecondproject-b4b4-amd64 (https://hub.docker.com/r/kasun.athugoda@gmail.com/mysecondproject-b4b4-amd64)
...
.. important::
   docker run -d -p 36165:36165 -p 43061:43061 -p 35263:35263 \-\-env TSS=0 \-\-env SOLUTIONNAME=mysecondproject-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-mysecondproject-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=36165  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=43061  \-\-env SOLUTIONVIPERVIZPORT=35263 \-\-env DOCKERUSERNAME='kasun.athugoda@gmail.com'  \-\-env EXTERNALPORT=39291 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasun.athugoda@gmail.com/mysecondproject-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=36165
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasun.athugoda@gmail.com/mysecondproject-b4b4-amd64
...
It can be accessed by entering: http://localhost:43061
...
.. important::
   http://localhost:35263/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:35263/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:35263/<html file>
...
[mysecondproject-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/mysecondproject-b4b4
...
.. important::
   https://mysecondproject-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_dag-mysecondproject-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=36165, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=32827, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46611, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43495, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40499, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39579, HPDEHOST=127.0.1.1, HPDEPORT=33363, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38691

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4178-mysecondproject-b4b4,solution_preprocessing_dag-mysecondproject-b4b4, python-preprocess-4896-mysecondproject-b4b4,solution_preprocessing_dag-mysecondproject-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
